    ...
    <div className="courses">
      ...
      <div className="courses-page d-grid m-20 gap-20">
        <div className="course bg-white rad-6 p-relative">
          ...
          <div className="info p-15 fs-14 p-relative between-flex">
            <span className="course-title bg-blue c-white btn-shape">
              Course Info
            </span>
        ...
        <div className="course bg-white rad-6 p-relative">
          ...
          <div className="p-20">
            ...
            <p className="description c-grey mt-15 fs-14">
              Master The Art Of Data Structures And Famous Algorithms Like
